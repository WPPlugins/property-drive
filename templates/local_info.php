...
add_action( 'wp_ajax_' . 'pd_local_info_load', 'pd_fetch_local_info' );
add_action( 'wp_ajax_nopriv_' . 'pd_local_info_load', 'pd_fetch_local_info' );
?>
