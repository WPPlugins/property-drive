    ...
    <div class="jtg-box">
        <a href="<?php the_permalink(); ?>">
            <div class="jtg-box-title">
                <div class="" style="margin-bottom: 10px;"><?php the_title(); ?></div>
            ...
            <div class="jtg-box-image">
                ...
                <span class="status" style=""><?php echo ucwords($status); ?></span>
            </div>
        </a>
        ...
        <div class="jtg-box-excerpt">
            <p>
                ...
                echo substr($string, 0, strrpos(substr($string, 0, 100), ' '));
                ?>
            </p>
        </div>
