...
<div class="jtg-row jtg-clearfix">
	...
	<div class="jtg-col-1-2">
		...
		<input id="jtg_search_back_color" class="color-picker" data-alpha="true" data-default-color="" name="search_background_color" type="text" value="<?php echo $options['search_background_color'] ?>" />

		<p><b>Search Button Background</b></p>
		<input id="jtg_search_btn_back" class="color-picker" data-alpha="true" data-default-color=""  name="search_btn_color" type="text" value="<?php echo $options['search_btn_color'] ?>" />

		<p><b>Search Button Hover Background</b></p>
		<p><input id="jtg_search_btn_hover_back" class="color-picker" data-alpha="true" data-default-color="" name="search_btn_hover_color" type="text" value="<?php echo $options['search_btn_hover_color'] ?>" /></p>

		<p><b>Search Button Text Color</b></p>
		<p><input id="jtg_search_btn_text_color" class="color-picker" data-alpha="true" data-default-color="" name="search_btn_text_color" type="text" value="<?php echo $options['search_btn_text_color'] ?>" /></p>


		<p><b>Search Button Hover Text Color</b></p>
		<p><input id="jtg_search_btn_hover_text_color" class="color-picker" data-alpha="true" data-default-color="" name="search_btn_hover_text_color" type="text" value="<?php echo $options['search_btn_hover_text_color'] ?>" /></p>



		<p><b>Price Slider Bar Color</b></p>
		<input id="jtg_price_bar_color" class="color-picker" data-alpha="true" data-default-color="" name="price_slider_bar" type="text" value="<?php echo $options['price_slider_bar'] ?>" />
