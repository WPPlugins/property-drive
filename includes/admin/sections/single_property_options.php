<?php
///////////////////////////////////////////////////////////////////////////////////////////////////////////
///  Single Property Page Options Section
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
<div class="jtg-admin-notice-light">
	<p>We have lots of options ready for you to play with to make your property page your own.</p>
	<p><i>These changes will affect the Single Property Page only.</i></p>
</div>
<div class="jtg-row jtg-clearfix">
	<div class="jtg-col-1-1">
		...
		<select id="jtg_single_page_template">
			...
			<option value="3" <?php if ( $options['jtg_single_page_template'] == '3' ) echo 'selected="selected"'; ?>>Template 3</option>
		</select>
	</div>
</div>
<div class="jtg-row jtg-clearfix">
